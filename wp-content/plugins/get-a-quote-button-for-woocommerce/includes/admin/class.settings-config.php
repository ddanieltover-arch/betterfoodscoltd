...
if (!class_exists('WPB_GQB_Plugin_Settings')):
    class WPB_GQB_Plugin_Settings
    {
        ...
        function __construct()
        {
            ...
            add_action('admin_head', array($this, 'admin_head_upgrade_styles'));
        }
        ...
        function admin_head_upgrade_styles()
        {
            ?>
            <style>
                #adminmenu .wp-submenu a[href$="page=<?php echo esc_attr($this->settings_name); ?>-pro"] .wpb-gqb-upgrade-menu-label {
                ...
                #adminmenu .wp-submenu a[href$="page=<?php echo esc_attr($this->settings_name); ?>-pro"]:hover .wpb-gqb-upgrade-menu-label {
                    color: #ffec6e !important;
                }
            </style>
            <?php
        }
        ...
        public function admin_menu_doc_support()
        {
            ...
            add_submenu_page(
                $this->settings_name,
                esc_html__('Upgrade to Pro', 'get-a-quote-button-for-woocommerce'),
                '<span class="wpb-gqb-upgrade-menu-label">&#11088; ' . esc_html__('Upgrade to Pro', 'get-a-quote-button-for-woocommerce') . '</span>',
                'manage_options',
            ...
            $settings_fields = array(
                'form_settings' => array(
                    ...
                    array(
                        ...
                        'type'    => 'select',
                        'options' => wp_list_pluck(get_posts(array('post_type' => 'wpcf7_contact_form', 'numberposts' => -1, 'orderby' => 'title', 'order' => 'ASC',)), 'post_title', 'ID'),
                    ),
                    array(
        ...
        {
            $plugin_data = function_exists('get_plugin_data') ? get_plugin_data(WP_PLUGIN_DIR . '/' . WPB_GQB_FREE_INIT, false, false) : array();
...
?>
            ...
            <div class="wpb-gqb-page-header">
                <div class="wpb-gqb-header-brand">
                    <span class="wpb-gqb-header-icon">
                        <span class="dashicons dashicons-money-alt"></span>
                    </span>
                    <div class="wpb-gqb-header-info">
                        <h1><?php esc_html_e('Get a Quote Button', 'get-a-quote-button-for-woocommerce'); ?></h1>
                        <div class="wpb-gqb-header-meta">
                            <span class="wpb-gqb-plan-badge"><?php esc_html_e('Free Plan', 'get-a-quote-button-for-woocommerce'); ?></span>
                            <?php if ($version) : ?>
                                <span class="wpb-gqb-version"><?php echo esc_html('v' . $version); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="wpb-gqb-header-actions">
                    <a href="<?php echo esc_url($pro_url); ?>" target="_blank" rel="noopener noreferrer" class="wpb-gqb-header-upgrade-btn">
            ...
            <div class="wpb-gqb-layout-row">
                <div class="wpb-gqb-col-main">
                    <?php
                    settings_errors();
                ...
                <aside class="wpb-gqb-col-sidebar">
                    <?php do_action('wpb_gqb_after_settings_page'); ?>
                </aside>
            </div>
