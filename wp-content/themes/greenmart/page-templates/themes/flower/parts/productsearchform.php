				...
				<div class="input-group">
					<?php if ( greenmart_tbay_get_config('search_type') != 'all' && $is_category ): ?>
						<div class="select-category input-group-addon">
							...
							<?php wc_product_dropdown_categories( apply_filters('greenmart_wc_search_arguments', $args) ); ?>
							...
							?>
								<?php wp_dropdown_categories( apply_filters('greenmart_post_search_arguments', $args) ); ?>
							<?php endif; ?>
					  	</div>
				  	<?php endif; ?>
