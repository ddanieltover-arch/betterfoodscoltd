<?php 
    ...
    if( $menu_option == 'smart_menu' ) {
        ...
        $enable_menu_shortcode        = greenmart_tbay_get_config('enable_menu_shortcode', false); 
        $menu_shortcode               = maybe_unserialize(greenmart_tbay_get_config('menu_shortcode'));
...
<div id="tbay-mobile-smartmenu" <?php echo trim($menu_attribute); ?> class="tbay-mmenu hidden-lg hidden-md <?php echo esc_attr($tbay_header);?>"> 
    ...
    <?php if ($enable_menu_shortcode && !empty($menu_shortcode) ) : ?>
        <div class="before-mm-navbar">
            <div class="mm-bottom-shortcode">
