            ...
            <div class="device-cart <?php echo is_cart() ? 'active' : '' ?>">
                <a class="mobil-view-cart" href="<?php echo ( !is_cart() ) ? wc_get_cart_url() : 'javascript:void(0);'; ?>" >
    				<span class="icon">
    					...
    					<span class="count mini-cart-items cart-mobile"><?php echo sprintf('%d', $cart_count); ?></span>
        ...
        <div class="device-wishlist">
            <a class="text-skin wishlist-icon" href="<?php $wishlist_url = YITH_WCWL()->get_wishlist_url(); echo esc_url($wishlist_url); ?>">
    			<span class="icon">
    				...
    				<span class="count count_wishlist"><?php $wishlist_count = yith_wcwl_count_products(); echo esc_attr($wishlist_count); ?></span>
