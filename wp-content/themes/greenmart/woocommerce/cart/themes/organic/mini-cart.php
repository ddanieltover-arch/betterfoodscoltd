	...
	<div class="mini_cart_inner">
		<div class="mcart-border">
								...
								<div class="product-details">  
									<?php
										echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
											'<a role="button" href="%s" class="remove" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s" data-success_message="%s">x</a>',
			...
			<?php if(sizeof(WC()->cart->get_cart()) > 0) : ?>
				...
				<p class="total"><?php esc_html_e('Subtotal', 'greenmart'); ?>: <?php wc_cart_totals_subtotal_html(); ?></p>
