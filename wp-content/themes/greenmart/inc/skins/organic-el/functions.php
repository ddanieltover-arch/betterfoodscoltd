...
if (!function_exists('greenmart_tbay_private_size_image_setup')) {
    function greenmart_tbay_private_size_image_setup() {
        ...
        // Thumbnail size
        if (intval(get_option('thumbnail_size_w')) !== 380 || intval(get_option('thumbnail_size_h')) !== 220) {
            update_option('thumbnail_size_w', 380);
            update_option('thumbnail_size_h', 220);
        }

        // Medium size
        if ( intval(get_option('medium_size_w')) !== 470 || intval(get_option('medium_size_h')) !== 272 ) {
            update_option('medium_size_w', 470);
            update_option('medium_size_h', 272);
        }

        // Large size
        if ( intval(get_option('large_size_w')) !== 470 || intval(get_option('large_size_h')) !== 272 ) {
