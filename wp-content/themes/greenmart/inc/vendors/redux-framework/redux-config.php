...
if (!class_exists('greenmart_Redux_Framework_Config')) {
    class greenmart_Redux_Framework_Config
    {
        ...
        public function setSections()
        {
            ...
            $this->sections[] = [
                'subsection' => true,
                'title' => esc_html__('Header Tablet/Mobile', 'greenmart'),
                'fields' => [
                    [
                        'id' => 'mobile-logo',
                        'type' => 'media',
            ...
            $this->sections[] = [
                ...
                'fields' => [
                    ...
                    [
                        'id' => 'enable_menu_shortcode',
                        'type' => 'switch',
                        'title' => esc_html__('Enable Menu Shortcode', 'greenmart'),
                        'required' => ['menu_mobile_type', '=', 'smart_menu'],
                        'default' => false,
                    ],
                    array(
                        'id'       => 'menu_shortcode',
                        'type'     => 'textarea',
                        'title'    => esc_html__('Menu Shortcode', 'greenmart'),
                        'desc' => esc_html__('The shortcode menu will be displayed above the social menu', 'greenmart'),
                        'required' => ['enable_menu_shortcode', '=', true],
                    ),
                    [
            ...
            $sections = [
                ...
                'fields' => [
                    [
                        ...
                        'title' => esc_html__('Header Background', 'greenmart'),
                    ],
                    [
