...
abstract class Greenmart_Elementor_Carousel_Base extends Greenmart_Elementor_Responsive_Base {
    ...
    private function get_rows() {
        $transient_key = 'greenmart_elementor_rows';
        $rows = get_transient($transient_key);

        if (false === $rows) {
            $rows = apply_filters('greenmart_admin_elementor_rows', [
                1 => 1,
                2 => 2,
                3 => 3,
            ]);
    ...
    /**
     * Add carousel controls to the widget.
     *
     * @param array $condition Conditions for displaying controls.
     */
    ...
    private function register_section_carousel_options( $condition = array() ) {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on'    => esc_html__('Show', 'greenmart'),
                'label_off'   => esc_html__('Hide', 'greenmart'),
                'default' => 'yes',
        ...
        $this->add_control(
            ...
            [ 
                ...
                'type' => Controls_Manager::SWITCHER,
                'label_on'    => esc_html__('Yes', 'greenmart'),
                'label_off'   => esc_html__('No', 'greenmart'),
                'default' => '',
