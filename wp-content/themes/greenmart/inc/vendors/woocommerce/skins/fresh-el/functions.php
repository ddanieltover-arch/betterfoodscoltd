...
if (!function_exists('greenmart_woocommerce_setup_size_image')) {
    ...
    function greenmart_woocommerce_setup_size_image() {
        ...
        $sizes = [
            'woocommerce_thumbnail_image_width' => 291,
            'woocommerce_single_image_width' => 570,
...
if (!function_exists('greenmart_tbay_woocommerce_limited_quantity')) {
    add_action('wp_footer', 'greenmart_tbay_woocommerce_limited_quantity');
    function greenmart_tbay_woocommerce_limited_quantity()
    {
        ?>
        <div class="toast-container d-flex justify-content-center align-items-center">
            <div id="tb-limited-notification" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3000">
                <div class="toast-body">
                    <?php esc_html_e('Sorry, we have a limited quantity available for this item!', 'greenmart'); ?>
                </div>
            </div>
