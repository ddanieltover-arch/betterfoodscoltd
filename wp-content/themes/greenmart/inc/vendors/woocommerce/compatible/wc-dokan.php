...
if (!function_exists('greenmart_tbay_body_classes_woocommerce_dokan_free')) {
    function greenmart_tbay_body_classes_woocommerce_dokan_free($classes)
    {
    ...
    add_filter('body_class', 'greenmart_tbay_body_classes_woocommerce_dokan_free');
}