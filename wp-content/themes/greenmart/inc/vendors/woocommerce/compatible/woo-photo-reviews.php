...
if (!function_exists('greenmart_woocommerce_photo_reviews_setup_support')) {
    ...
    function greenmart_woocommerce_photo_reviews_setup_support() {
        ...
        $width = (int) get_option('greenmart_photo_reviews_thumbnail_image_width', 100);
        $height = (int) get_option('greenmart_photo_reviews_thumbnail_image_height', 100);
        ...
        $size_name = 'greenmart_photo_reviews_thumbnail_image';
        add_image_size($size_name, $ptreviews['width'], $ptreviews['height'], $ptreviews['crop']);
    }
}
