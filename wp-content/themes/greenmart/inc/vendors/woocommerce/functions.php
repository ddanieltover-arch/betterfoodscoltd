...
if (!function_exists('greenmart_tbay_woocommerce_get_display_mode')) {
    function greenmart_tbay_woocommerce_get_display_mode()
    {
        ...
        if ($skin === 'fresh-el') {
            ...
            if (! greenmart_woo_is_vendor_page() && ! is_shop() && ! is_product_taxonomy()) {
                $woo_mode = 'grid';
            }
        }
    ...
    function greenmart_tbay_woocommerce_tabs_style_product($tabs_layout)
    {
        if (is_singular('product')) {
            ...
            if (isset($_GET['tabs_product'])) {
                $allowed_tabs   = ['default', 'tbhorizontal', 'tbvertical', 'accordion'];
                $tabs_layout    = in_array($_GET['tabs_product'], $allowed_tabs) ? $_GET['tabs_product'] : $tabs_style;
            } else {
...
if (!function_exists('greenmart_tbay_woocommerce_add_video_field')) {
    ...
    {
        $args = apply_filters(
            'greenmart_tbay_woocommerce_simple_url_video_args',
            [
        'id' => '_video_url',
 ...
 * ------------------------------------------------------------------------------------------------
 */
if (! function_exists('greenmart_the_yith_compare')) {
    function greenmart_the_yith_compare()
    {
        if (class_exists('YITH_Woocompare_Frontend')) { 
            ?>
            <div class="yith-compare">

                <?php do_action('greenmart_before_add_to_compare_button'); ?>
...
if (! function_exists('greenmart_remove_compare_button_from_loop')) {
    add_action( 'init', 'greenmart_remove_compare_button_from_loop', 20 );
    function greenmart_remove_compare_button_from_loop() {
        if ( class_exists( 'YITH_Woocompare_Frontend' ) ) {
            ...
            add_action( 'greenmart_before_add_to_compare_button', array( $frontend, 'output_button' ), 10 );
        }
    }
}