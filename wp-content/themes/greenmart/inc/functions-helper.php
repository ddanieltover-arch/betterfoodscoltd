...
if ( !function_exists('greenmart_tbay_get_header_layouts_elementor') ) {
    function greenmart_tbay_get_header_layouts_elementor() {
        $transient_name = 'greenmart_header_layouts_elementor';
        
        $headers = get_transient($transient_name);
        ...
        if (false === $headers) {
            ...
            set_transient($transient_name, $headers, WEEK_IN_SECONDS);
        }
...
if (!function_exists('greenmart_tbay_get_header_layouts_folder')) {
    function greenmart_tbay_get_header_layouts_folder() {
        $transient_key = 'greenmart_header_layouts_' . greenmart_tbay_get_theme();
        $headers = get_transient($transient_key);

        if (defined('WP_DEBUG') && WP_DEBUG === true || false === $headers) {
            ...
            set_transient($transient_key, $headers, MONTH_IN_SECONDS);
        }
...
if ( !function_exists('greenmart_tbay_get_footer_layouts') ) {
    function greenmart_tbay_get_footer_layouts() {
        $transient_name = 'greenmart_footer_layouts';
        
        $footers = get_transient($transient_name);
        ...
        if (false === $footers) {
            ...
            set_transient($transient_name, $footers, WEEK_IN_SECONDS);
        }
...
if (!function_exists('greenmart_wpml_is_activated')) {
    function greenmart_wpml_is_activated()
    {
...
if ( ! function_exists( 'greenmart_wpml_object_id' ) ) {
	function greenmart_wpml_object_id( $element_id, $element_type = 'post', $return_original_if_missing = false, $language_code = null ) {
