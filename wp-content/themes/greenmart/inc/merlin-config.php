    ...
    public function init()
    {
        $wizard = new Merlin(
            ...
            $strings = array(
                ...
                'ready-link-2'      => sprintf('<a href="%1$s">%2$s</a>', 'https://thembay-docs.gitbook.io/greenmart/', esc_html__('Documentation', 'greenmart')),
...
- - - - - - - - - - - - - - - - - - - - */";
    ...
    private function update_option_yith_wcwl()
    {
        ...
        update_option('yith_wcwl_add_to_wishlist_text', 'Wishlist');
    }
